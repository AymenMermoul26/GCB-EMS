-- =====================================================================
-- Public profile visibility auditing
-- - Preserves the existing public QR read model
-- - Records successful public profile loads in audit_log
-- - Adds an action/timestamp index used by monitoring and dashboards
-- =====================================================================
