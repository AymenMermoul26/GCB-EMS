...
The `invite-employee` edge function now sends invite/access emails through the Gmail API instead of Supabase's built-in mailer. Set these Supabase project secrets as well:
