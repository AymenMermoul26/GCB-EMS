...
function BadgeFace({
  ...
  if (side === 'front') {
    return (
      ...
      >
        <div className="absolute inset-x-0 top-0 h-2 bg-gradient-to-br from-[#ff6b35] to-[#ffc947]" />
        <div className="absolute -right-12 top-6 h-28 w-28 rounded-full bg-[#ffc947]/20 blur-2xl" />
        <div className="absolute -left-12 bottom-8 h-28 w-28 rounded-full bg-[#ff6b35]/15 blur-2xl" />
        <div className="absolute right-8 top-24 grid grid-cols-6 gap-2 opacity-15">
          ...
          <div className="flex items-start justify-between gap-4 text-slate-900">
            <div className="flex min-w-0 items-center gap-4">
              ...
              <div className="min-w-0 space-y-1 leading-tight">
                <p className="max-w-[392px] text-[15px] font-extrabold uppercase tracking-[0.075em] text-slate-900">
                  {COMPANY_NAME_FULL}
                </p>
            ...
            <span className="pt-1 text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">
              Employee Badge
            </span>
          </div>

          <div className="mt-6 flex flex-1 items-center gap-8">
            <div className="h-56 w-44 overflow-hidden rounded-xl border border-slate-200 bg-slate-100 shadow-sm">
              {photoUrl ? (
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 text-[38px] font-bold leading-tight text-slate-900">{fullName}</p>
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col p-7">
        <div className="flex items-center justify-between text-slate-900">
          <div className="flex min-w-0 items-center gap-4">
            <img
              ...
              />
            <div className="min-w-0 space-y-1 leading-tight">
              <p className="max-w-[360px] text-[12px] font-extrabold uppercase tracking-[0.075em] text-slate-900">
                {COMPANY_NAME_FULL}
              </p>
              <p className="text-[10px] uppercase tracking-[0.16em] text-slate-500">
                Employee Identification Badge
        ...
        <div className="mt-5 flex flex-1 items-center gap-8">
          <div className="flex h-56 w-56 items-center justify-center rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            {publicProfileUrl ? (
          ...
          <div className="flex-1 space-y-4 text-sm leading-relaxed text-slate-700">
            ...
            <p>
              This card identifies <span className="font-semibold">{fullName}</span>,{' '}
        ...
        <div className="mt-4 flex items-center justify-between border-t border-slate-200 pt-3 text-xs">
          <p className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 font-mono text-slate-700">
            ID: {matricule}
          </p>
          <p className="text-slate-500">If found, please return it to the HR Department.</p>
        </div>
      </div>
    </div>
  )
